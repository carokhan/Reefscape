...
public class AutoRoutines {
                                ...
                                AutoAlign.translateToPose(
                                        ...
                                        () -> AllianceFlipUtil.apply(
                                                Reef.centerFaces[AutoAlign.getBestFace(drive.getPose(), 0, 0)]
                                                        .rotateAround(
                                                                Reef.centerFaces[AutoAlign.getBestFace(drive.getPose(),
                                                                        0, 0)]
                                                                        .getTranslation(),
                                                                Rotation2d.k180deg)))));
        return routine.cmd();
    ...
    public Command LMtobarge() {
        return Commands.sequence(
                ...
                Commands.waitSeconds(1),
                Commands.deadline(Commands.waitUntil(() -> DriverStation.getMatchTime() > 2.0),
                        Commands.sequence(this.Ftobarge().onlyWhile(superstructure.gripper::getDetected),
                                this.bargetoPLO())),
                this.bargetoPLO());
    }
    ...
    public boolean atReef() {
        return drive
                ...
                .getTranslation()
                .getDistance(
                        AllianceFlipUtil.apply(FieldConstants.Reef.center)) < ElevatorConstants.autoReefRaiseDistance;
    }
    ...
    public boolean atBarge() {
        double threshold = DriverStation.getAlliance()
