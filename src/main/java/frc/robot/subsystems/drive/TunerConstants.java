...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(1).withKI(0).withKD(0).withKS(0.17899).withKV(0.67742);
  ...
  private static final Distance kWheelRadius = Inches.of(1.678);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.273193359375);
